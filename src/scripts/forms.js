...
barba.hooks.after((data) => {
  ...
  if (info == "form") {
    ...
    if (data.next.container.id == "form1Main") {
      document.getElementById("formBackArrow1").addEventListener(
        "click",
        () => {
          console.log("form1");
          barba.go("/offer.html");
    ...
    if (data.next.container.id == "form2Main") {
      document.getElementById("formBackArrow2").addEventListener(
        "click",
        () => {
          console.log("form2");
          barba.go("/offer.html");
    ...
    document
      .getElementsByClassName("couple")[0]
