...
//eventlisteners
document.getElementsByTagName("body")[0].addEventListener('load', menuBoldAnimation(undefined));
document.getElementsByTagName("body")[0].addEventListener('load', menuClosing());
document.getElementsByTagName("body")[0].addEventListener('load', deviceResolving(undefined,pageAfterReload));
...
function menuClosing(){
    ...
    function animation(){
        let hmbMenu = document.getElementsByClassName("toggleMenu")[0].firstElementChild;
